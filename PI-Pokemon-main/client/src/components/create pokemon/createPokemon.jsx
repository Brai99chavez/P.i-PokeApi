        ...
        <div className="create-all-inputs">
          ...
          {errors.error_name && (
            <div className="show-error">
              <p>{errors.error_name}</p>
            </div>
          )}
          {errors.error_existing_name && (
            <div className="show-error">
              <p>{errors.error_existing_name}</p>
            </div>
          )}
          <div className="create-input">
            <p>height:</p>
          ...
          {errors.error_null && (
            <div className="show-error">
              <p>{errors.error_null}</p>
            </div>
          )}
          {errors.error_duplicate && (
            <div className="show-error">
              <p>{errors.error_duplicate}</p>
            </div>
          )}
        </div>
